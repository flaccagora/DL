...
from kan.KAN import KAN as KAN
...
class CausalSelfAttention(nn.Module):
    ...
    def plot(self, beta):
        print("plotting attention kan")
        self.c_attn.plot(beta)
        self.c_proj.plot(beta)
...
class Block(nn.Module):
    ...
    def plot(self, beta):
        print("hello?")
        #self.attn.plot(beta)
        print("plotting MLP kan")
        self.mlp.c_fc.plot(beta)
        self.mlp.c_proj.plot(beta)
